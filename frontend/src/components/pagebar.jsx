...
import { MessageCircle, Video, User, ChevronDown, Menu } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <li className="hover:border-b-2 hover:border-gray-300 transition">
            ...
            <li className="hover:border-b-2 hover:border-gray-300 transition">
             <Link to='/flight'>Flights</Link></li>
             <li className="hover:border-b-2 hover:border-gray-300 transition">
             <Link to='/places'>Attractions</Link></li>
          </ul>
          ...
          <button className="p-1 transition-all duration-200 hover:text-gray-300"> 
             <Video className="w-6 h-6 cursor-pointer hover:text-gray-300 text-white" />
          </button>
