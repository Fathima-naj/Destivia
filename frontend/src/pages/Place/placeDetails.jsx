    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="mb-8 bg-white p-6 rounded-xl shadow">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3 mt-4">
          ...
          <button
            disabled
            className="bg-gray-400 text-white cursor-pointer px-6 py-2 rounded-lg shadow-md text-sm md:text-base cursor-not-allowed"
          >
            ✅ Booked
          </button>
        ) : (
          <button
            onClick={() =>navigate('/p-booking',{state:{
              place:place
            }})}
